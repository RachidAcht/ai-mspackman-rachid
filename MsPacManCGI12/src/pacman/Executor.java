...
import pacman.entries.pacman.rachid.behaviortree.RachidPacManTree; // comment this 
import pacman.entries.pacman.rachid.mcts.RachidPacManMcts; 
...
//		exec.runGame(new StarterPacMan(), new Legacy2TheReckoning(), visual,delay);
		exec.runGame(new RachidPacManTree(), new Legacy2TheReckoning(), visual,delay);
//		
		/* run multiple games in batch mode - good for testing. */
//		
//		System.out.println("STARTER PACMAN vs LEGACY2THERECONING");
//		exec.runGame(new StarterPacMan(), new Legacy2TheReckoning(),visual, delay);
//		exec.runGameTimed(new RachidPacManMcts(),new Legacy2TheReckoning(),visual);
////		
...
//		exec.runGameTimed(new RachidPacManTree(),new AggressiveGhosts(),visual);
//		exec.runGameTimed(new RachidPacManMcts(),new AggressiveGhosts(),visual);
...
//		exec.runGameTimedRecorded(new RachidPacManMcts(),new AggressiveGhosts(),visual,fileName);
